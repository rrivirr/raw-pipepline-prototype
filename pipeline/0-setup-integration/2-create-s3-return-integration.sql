...
-- old combined account
-- CREATE OR REPLACE STORAGE INTEGRATION flow_correction_s3_integration
--   TYPE = EXTERNAL_STAGE
--   STORAGE_PROVIDER = 'S3'
--   ENABLED = TRUE
--   STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::569068051646:role/SnowflakeDevReadOnly'
--   STORAGE_ALLOWED_LOCATIONS = ($s3_bucket);
